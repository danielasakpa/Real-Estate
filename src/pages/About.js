...
const About = () => {
  return (
    ...
    >
      ...
      <div className='relative mx-auto mt-16 md:mt-20 md:block xs:w-[100%] h-[250px] overflow-hidden lg:w-[60%] lg:h-[500px]'>
        <m.img
          initial={{ scale: 1.2 }}
          whileInView={{ scale: 1 }}
          transition={{ duration: 0.75, ease: "easeIn" }}
          viewport={{ once: true }}
          className='rounded-lg h-[250px] lg:h-[500px]' src={about1Img} alt="about1Img" />
        <m.div
          initial={{ width: "100%" }}
          whileInView={{ width: "0" }}
      ...
      <div className='mt-[100px] flex xs:flex-col md:flex-row justify-between md:items-center'>
        ...
        <div children="basis-1/2 flex justify-end">
          <button className='mr-5 px-6 py-3 font-Arimo bg-[#FFFFFF] border-solid border border-[#1F1717] border-opacity-25 rounded-md  text-black hover:bg-stone-100  hover:text-stone-900 hover:border-opacity-50 hover:border hover:border-black'
          >
            More details
          </button>
          <button className='xs:px-3 md:px-4 xs:py-4 md:py-3 xs:text-[14px] md:text-[15px] font-Arimo bg-[#000000]  rounded-md  text-stone-50 hover:bg-stone-100  hover:text-stone-900 border border-opacity-0 hover:border-opacity-25 border-[#1e293b]'
          >
            Contact us
          </button>
        </div>
      ...
      <div className='flex flex-wrap items-center mt-16 xs:flex-col md:flex-row xs:justify-center lg:justify-between'>
        {ratings.map((rating, i) =>
          <m.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            key={i} className='h-[100px] xs:w-[100%] xs:mb-4 md:w-[280px] px-3 py-5 flex items-center rounded-lg shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] bg-[#ffffff]'>
        ...
        <div className='grid gap-4 mt-7 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 '>
          {result.map((image, i) =>
            <m.div
              ...
              viewport={{ once: true, amount: 0.3 }}
              key={i}
              className='flex h-[170px] w-[280px] px-3 py-5 justify-center items-center rounded-lg shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] bg-[#FFFFFF]'>
