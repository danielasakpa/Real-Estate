...
const About = () => {
  ...
  return (
    <div>
      ...
      <img className='mt-20 xs:hidden md:flex mx-auto xs:w-[100%] lg:w-[60%] rounded-lg' src={about1Img} alt="about1Img" />
      ...
      <div className='flex xs:flex-col md:flex-row mt-16 xs:justify-center lg:justify-between items-center flex-wrap'>
        {ratings.map((rating, i) =>
          <div key={i} className='h-[100px] xs:w-[100%] xs:mb-4 md:w-[280px] px-3 py-5 flex items-center rounded-lg shadow-xl  bg-[#FFFFFF]'>
      ...
      <div className='flex xs:flex-col lg:flex-row xs:mt-[70px] lg:mt-[200px] justify-between'>
        ...
        <div>
          <img className='xs:h-[100%] lg:h-[400px] xs:mt-5 lg:mt-0 lg:mb-0 mx object-cover lg:w-[2500px] rounded-lg' src={testimonialImg} alt="testimonialImg" />
        </div>
      </div>
      <div className='xs:mt-[100px] flex flex-col items-center lg:mt-[200px]'>
        ...
        <div className='mt-7 grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 '>
          {result.map((image, i) =>
            <div className='flex h-[170px] w-[280px] px-3 py-5 justify-center items-center rounded-lg shadow-lg bg-[#FFFFFF]'>
