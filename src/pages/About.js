  ...
  return (
    ...
    >
      ...
      <m.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className='flex flex-wrap items-center px-2 mt-16 xs:flex-col md:flex-row xs:justify-center lg:justify-between'>
      ...
      <div className='xs:mt-[100px] flex flex-col items-center lg:mt-[200px]'>
        ...
        <m.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className='grid gap-4 mt-7 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-2'>
          {result.map((image, i) =>
            <m.div
              variants={cardItem}
              key={i}
