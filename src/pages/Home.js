    ...
    return (
        ...
        >
            ...
            <div className='list-none'>
                ...
                <div className='flex justify-center items-center mt-[50px] md:mt-[80px] w-[100%]'>
                    <Link to='/properties'>
            ...
            <section>
                <div className='py-14 xs:block mt-[60px] lg:flex'>
                    <m.div
                        ...
                        <m.p variants={item} className='xs:text-[16px] lg:text-[17px] text-[#1F1717] mb-3 font-medium font-Barlow'>YOUR TRUST HELPS</m.p>
                        <m.h1 variants={item} className='xs:text-[45px] lg:text-[30px] xl:text-[50px] text-[#000000] font-Questrial text-left xs:leading-[48px] lg:leading-[40px] xl:leading-[50px] font-bold'>A headline to make an impact on visitors</m.h1>
                        <m.p variants={item} className='xs:text-[18px] xl:text-[22px]  text-[#1F1717] mt-4 font-Arimo'>We work to elevate you experience and help you make <br className='xs:hidden lg:block' /> inhtmlFormed decisions.</m.p>
                ...
                <m.div
                    ...
                    whileInView="show"
                    viewport={{ once: true }}
                    className='grid gap-4 m-10 mx-auto xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-3'>
